...
function AnimatedBars() {
  ...
  const bars = [40, 65, 50, 80, 55, 90, 70, 60, 85, 75, 95, 60];
  ...
  return (
    <div ref={containerRef} className="flex h-24 items-end gap-1.5">
      {bars.map((h, i) => (
        <div
          key={i}
          className="flex-1 rounded-t bg-gradient-to-t from-amber-600/40 to-amber-400/80 transition-all duration-700 ease-out"
          style={{
            height: visible ? `${h}%` : '0%',
    ...
    <section id="top" className="relative overflow-hidden pt-32 pb-20 md:pt-44 md:pb-28">
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="animate-fade-up mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-400" style={{ animationDelay: '100ms' }}>
          ...
          <div className="animate-fade-up mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row" style={{ animationDelay: '200ms' }}>
            <a
              href="#features"
          ...
          <div className="animate-fade-up mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-slate-500" style={{ animationDelay: '300ms' }}>
            <span className="inline-flex items-center gap-2">
              <ShieldCheck className="h-4 w-4 text-amber-500" /> Seguridad por roles
            </span>
            <span className="inline-flex items-center gap-2">
              <Zap className="h-4 w-4 text-amber-500" /> Automatización de procesos
            </span>
            <span className="inline-flex items-center gap-2">
              <BarChart3 className="h-4 w-4 text-amber-500" /> Auditoría completa
            </span>
          </div>
        </div>

        <div className="animate-fade-up relative mx-auto mt-16 max-w-5xl" style={{ animationDelay: '400ms' }}>
          <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-amber-500/20 via-amber-500/5 to-blue-500/10 blur-2xl" />
          <div className="relative rounded-2xl border border-white/10 bg-ink-900/80 p-2 shadow-2xl backdrop-blur">
            <div className="relative overflow-hidden rounded-xl bg-ink-950">
              <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-px bg-gradient-to-r from-transparent via-amber-400/40 to-transparent animate-scan-line" />
              ...
              <div className="grid grid-cols-12 gap-3 p-4">
                ...
                <div className="col-span-12 md:col-span-9">
                  ...
                  <div className="mt-3 rounded-lg border border-white/5 bg-ink-900 p-4">
